...
export declare class AsyncInMemoryEventBus implements EventBus<true> {
    private readonly subscribers;
    private readonly store;
    private readonly maxRetries;
    private readonly deadLetterStore;
    constructor(store?: EventStore<true>, maxRetries?: number, deadLetterStore?: DeadLetterStore);
